...
def vpg(env_fn, actor_critic=core.mlp_actor_critic, ac_kwargs=dict(), seed=0, 
    ...
    paramsPublisher = rospy.Publisher("params_topic", LearnedParameters)
    ...
    def update():
        ...
        #*** store network parameters and send via ros ***
        #no idea if this worksf
        learnedParameters = []
        for v in tf.trainable_variables:
            learnedParameters.append(v.numpy())

        paramsPublisher.publish(learnedParameters)
