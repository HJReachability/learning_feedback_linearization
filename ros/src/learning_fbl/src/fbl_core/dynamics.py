...
class Dynamics(object):
    ...
    def linearized_system_state(self, x):
        """ Compute y from x. """
        raise NotImplementedError('linearized_system_state not implemented')
        return y

    def linearized_system(self):
        """ Return the linear dynamics of the feedback-linearized system A, B, C """
    ...
    def get_Mf(self, x):
        ...
        raise NotImplementedError('get_Mf not implemented')
        return M, f
