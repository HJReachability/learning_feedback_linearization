from spinup2.user_config import DEFAULT_DATA_DIR, FORCE_DATESTAMP, \
                               DEFAULT_SHORTHAND, WAIT_BEFORE_LAUNCH
from spinup2.utils.logx import colorize
from spinup2.utils.mpi_tools import mpi_fork, msg
